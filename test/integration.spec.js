...
import Collection from "../src/ReactiveRecord/Collection"
import { createStore, applyMiddleware, compose } from "redux"

describe("Integrations", ()=>{
  /*******/ /* Minimal ReactiveRecord boilerplate */
  /*******/ const Post = ReactiveRecord.model("Post", class extends Model {
  /*******/   static schema = {
  /*******/     userId: Number,
  /*******/     title: String,
  /*******/     body: String
  /*******/   }
  /*******/ });
  /*******/ const CurrentUser = ReactiveRecord.model("CurrentUser", class extends Model {
  /*******/   static schema = {
  /*******/     id: Number,
  /*******/     name: String,
  ...
  /*******/   applyMiddleware(ReactiveRecord::middleware())
  /*******/ );
